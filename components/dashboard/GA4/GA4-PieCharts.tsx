...
const PieChartComponent = ({
    ...
    return (
        <Card className="w-full border dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
            <CardHeader>
...
export default function GA4PieCharts({
    ...
    return (
        <div className="w-full flex flex-col md:flex-row lg:flex-col space-y-4">
            {chartsData.map((chart, idx) => (
                <PieChartComponent
                    key={idx}
                    title={chart.title}
