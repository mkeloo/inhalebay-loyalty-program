...
import GA4Statistics from "../../../../components/dashboard/GA4/GA4-Statistics";
import GA4PieCharts from "../../../../components/dashboard/GA4/GA4-PieCharts";
import GA4PageActivityLineChart from "../../../../components/dashboard/GA4/GA4-PageActivityLineChart";
import GA4PageViewBreakdown from "../../../../components/dashboard/GA4/GA4-PageViewBreakdown";
...
const CMSDashboard = () => {
    ...
    React.useEffect(() => {
        const fetchGAData = async () => {
            ...
            try {
                ...
                // const response = await fetch(`https://braindriptech.com/api/analytics/report/${days}`);
    ...
    return (
        <main className="w-full flex flex-col items-center justify-center gap-4">
            <div className="w-full h-full flex flex-col lg:flex-row items-stretch justify-between gap-3">
                {/* Page Activity Related Stuff */}
                <div className="w-[70%] h-full border-none rounded-none p-0 md:border md:rounded-xl md:p-2 space-y-2">
